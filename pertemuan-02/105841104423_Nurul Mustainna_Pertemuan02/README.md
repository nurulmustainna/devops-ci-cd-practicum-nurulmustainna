...
<body>
    <div class="container">
        ...
        <p>NIM: 105841104423</p>
        <p>Nama: INurul Mustainna</p>
    </div>
</body>
</html>
```
...
- [x] Memahami perbedaan container vs virtual machine
- [x] Dapat menjalankan dan mengelola container Docker
- [x] Berhasil membuat custom Docker image dengan Dockerfile
- [x] Berhasil menjalankan multi-container dengan Docker Compose
- [x] Semua screenshot lengkap dan jelas
- [x] Laporan ditulis dengan rapi
